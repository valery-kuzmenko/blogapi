...
class BlogFixtures implements FixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        $titles = array('A day with Symfony2', 'The pool on the roof must have a leak', 'Misdirection. What the eyes see and the ears hear, the mind believes');
        $content = array(
        ...
        $images = array('beach.jpg', 'pool_leak.jpg', 'misdirection.jpg');
        $authors = array('dsyph3r', 'Zero Cool', 'Gabriel');
        ...
        for ($i = 0; $i <= 20; $i++) {
            $data_titles[] = $titles[rand(0, 2)];
            $data_content[] = $content[rand(0, 2)];
            $data_images[] = $images[rand(0, 2)];
            $data_authors[] = $authors[rand(0, 2)];
            $data_tags[] = $tags[rand(0, 2)];
            $data_keywords[] = $keywords[rand(0, 2)];
        }
